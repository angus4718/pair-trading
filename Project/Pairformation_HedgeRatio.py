...
train_pair_spread.to_csv("output/train_pair_spread.csv")
train_half_life.to_csv("output/train_half_life.csv")
test_pair_spread.to_csv("output/test_pair_spread.csv")
test_half_life.to_csv("output/test_half_life.csv")
